...
const Elixir = ({ t }) =>
{
    return (
        <App>
            <Helmet>
                <title>Elixir</title>
                <meta property="og:description" content="Elixir é o primeiro álbum da banda mineira Pathos, lançado no dia 6 de Agosto de 2015." />
                <meta property="og:image" content="http://pathos.band/image/elixir.jpg" />
